module.exports = async function createProject(params) {
  ...
  // TODO: write a function to create todoist project along with this
  // perhaps a page that has a todoist filter as well to pull in all the todos within obsidian
  // link todoist project to obsidian project file (as a task that can not be completed in the root of the project)
